...
def _visualize(GG, dot_filename, png_filename, colors=None, labelNodes=True, labelArcs=True, labelWeight=True, timeout=1, scale=1, useNx=False):
    """
        ...
        - If useNx is set, the rendering is done using networkx support.
...
def visualize(G, colors=None, labelNodes=True, labelArcs=True, labelWeight=True, timeout=1, scale=1, useplt=False, useNx=False):
    """
    ...
    _visualize(G, dot_filename, png_filename, colors, labelNodes=labelNodes, labelArcs=labelArcs, labelWeight=labelWeight, scale=scale, useNx=useNx)
...
def save(G, dot_filename=None, png_filename=None, colors=None, labelNodes=True, labelArcs=True, useNx=False):
    """
    ...
    if png_filename is None:
        png_filename = tempfile.NamedTemporaryFile(suffix=".png").name
    _visualize(G, dot_filename, png_filename, colors, labelNodes, labelArcs, useNx=useNx)
